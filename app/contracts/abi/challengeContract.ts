    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          {
            internalType: "uint256",
            name: "successfulStreams",
            type: "uint256",
          },
        ],
        indexed: false,
        internalType: "struct DataTypes.ChallengeStreamerParams",
        name: "streamer",
        type: "tuple",
      },
    ],
